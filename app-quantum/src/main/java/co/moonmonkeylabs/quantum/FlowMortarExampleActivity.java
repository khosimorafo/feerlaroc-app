...
import co.moonmonkeylabs.quantum.common.actionbar.ActionBarOwner;
import co.moonmonkeylabs.quantum.common.dagger.ObjectGraphService;
import co.moonmonkeylabs.quantum.common.flow.FlowHistoryDevHelper;
import co.moonmonkeylabs.quantum.common.flow.GsonParceler;
import co.moonmonkeylabs.quantum.common.flow.HandlesBack;
import co.moonmonkeylabs.quantum.common.lifecycle.LifecycleActivity;
    ...
    implements ActionBarOwner.Activity, Flow.Dispatcher {
      ...
      public void dispatch(Flow.Traversal traversal, Flow.TraversalCallback callback) {
          ...
          actionBarOwner.setConfig(
              new ActionBarOwner.Config(false, !(newScreen instanceof DriversScreen), title, null));
      ...
      protected void onCreate(Bundle savedInstanceState) {
          ...
          flowDelegate = FlowDelegate.onCreate(
              ...
              savedInstanceState,
              parceler,
              History.single(new DriversScreen()), this);
      }
