...
public class ControllableCoordinatorLayout extends CoordinatorLayout {
    ...
    public ControllableCoordinatorLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public ControllableCoordinatorLayout(Context context, AttributeSet attrs, int defStyleAttr) {
